...
public class GradleVerifier extends CodeVisitorSupport implements BuildSystemVerifier {
    ...
    public void verify(IssueRestClient issueClient, Issue issue, HashSet<VerificationMessage> hostingIssues) throws IOException {
        ...
        forkTo = JiraHelper.getFieldValueOrDefault(issue, JiraHelper.FORK_TO_JIRA_FIELD, "");
        forkFrom = JiraHelper.getFieldValueOrDefault(issue, JiraHelper.FORK_FROM_JIRA_FIELD, "");
...
//                    System.out.println(e.getText());
    ...
    private void checkJenkinsVersion(Expression e, HashSet<VerificationMessage> hostingIssues) {
        if(e instanceof ConstantExpression) {
            ...
            if(jenkinsVersion.compareTo(HostingChecker.LOWEST_JENKINS_VERSION) < 0) {
